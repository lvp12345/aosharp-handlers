...
namespace Formation
{
    ...
    public static class SettingsController
    {
        ...
        private static void RegisterChatCommandIfNotRegistered()
        {
            ...
            {
                Chat.RegisterCommand("formation", (string command, string[] param, ChatWindow chatWindow) =>
                {
                    try
                    {
                        ...
                        settingsWindow = Window.Create(new Rect(50, 50, 300, 300), "Formation", "Settings", WindowStyle.Default, WindowFlags.AutoScale);

                        if (settingsWindow != null && !settingsWindow.IsVisible)
                        {
                            AppendSettingsTab("Formation", settingsWindow);
